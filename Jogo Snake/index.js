    ...
    listen() {
        addEventListener(
            ...
            (e) => {
                ...
                if (e.Key === "ArrowLeft" && this.ArrouwRight) return;
...
class Food {
    ...
    draw() {
        ...
        CTX.fillStyle = this.color;
        CTX.fillRect(x, y, this.size, this.size);
        CTX.globalCompositeOperation = "sourcer-over";
        CTX.shadowBlur = 0;
 ...
 class Particles {
    ...
    draw(){
        ...
        let hsl = this.color 
            .split("")
            .split((l) => l.match(/[^hs()$%]/g))
            .join("")
            .split(",")
            .map((n) => +n);
            let [r, g, b] = helpers.hsl2rgb(hsl[0], hs[1] / 100, hsl[2] / 100);

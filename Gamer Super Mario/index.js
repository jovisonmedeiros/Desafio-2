//logica para animar o mario a pular
...
const loop = setInterval(() => {
    ...
    const marioPosition = +window.getComputedStyle(mario).bottom.replace('px', ' ');// Deslocamento da altura que o Mário está, replace para tirar o px e ficar só o número e o + é para transformar a string em número
